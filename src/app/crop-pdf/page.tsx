    ...
    <main className="min-h-screen bg-[#f7f8fc]">
      <section className="mx-auto max-w-[1500px] px-5 py-10">
        ...
        <section className="mx-auto mt-16 max-w-6xl rounded-[32px] border border-slate-200 bg-white px-6 py-10 shadow-sm md:px-10">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-black tracking-[-0.03em] text-slate-950 md:text-4xl">How to crop a PDF online</h2>
            <p className="mt-4 text-base leading-7 text-slate-600">Upload your PDF, draw the area you want to keep, adjust the crop selection, choose whether to apply it to one page or all pages, then download the cropped PDF.</p>
          </div>
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <h3 className="font-black text-slate-950">1. Upload your PDF</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Choose a PDF file and open it in the visual crop editor.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <h3 className="font-black text-slate-950">2. Select the crop area</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Draw a crop box, resize it with the handles, and reposition it to keep the exact area you need.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <h3 className="font-black text-slate-950">3. Apply and download</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Apply the crop to the first page or all pages, then download the finished PDF.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto mt-8 max-w-6xl grid gap-6 md:grid-cols-2">
          <div className="rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm">
            <h2 className="text-2xl font-black tracking-[-0.02em] text-slate-950">Visual PDF cropping controls</h2>
            <p className="mt-3 text-base leading-7 text-slate-600">Select the crop area directly on the PDF preview, resize it from any side or corner, and move the selection until it is positioned correctly.</p>
          </div>
          <div className="rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm">
            <h2 className="text-2xl font-black tracking-[-0.02em] text-slate-950">Private browser-based processing</h2>
            <p className="mt-3 text-base leading-7 text-slate-600">Your PDF stays on your device while the crop is applied directly in your browser.</p>
          </div>
        </section>
